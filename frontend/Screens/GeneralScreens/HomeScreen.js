        ...
        return (
            ...
            >
                <View style={styles.header}>
                    <TouchableOpacity onPress={() => navigation.navigate('Profile')} style={styles.circle}>
                    ...
                    <View style={styles.content}>
                        ...
                        <View style={styles.row}>
                            ...
                            >
                                ...
                                <Text style={styles.subText}>Unlock the world of Bamesing's greatest ideals and traditions.</Text>
                                <View style={styles.icon}>
                        ...
                        <View style={styles.row}>
                            ...
                            >
                                ...
                                <Text style={styles.subText}>Navigate through the land of Bamesing, learning it's beautiful culture.</Text>
                                <View style={styles.icon}>
